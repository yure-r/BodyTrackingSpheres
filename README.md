...
To do so you would:
1. Click on "new project" and at the bottom of that dropdown, click "import from GitHub" 
2. Change the url to https://github.com/yure-r/BodyTrackingSpheres
3. Glitch will automatically clone the "main" branch into the project. 
