...
// myObject.name = "objectName";
  ...
  makePerson(1, 0, 0, 150, 32, 'hand_right_y', 'red',0.5 ,0.5);
  makePerson(5, 0, 0, 150, 32, 'handtip_right_y', 'red',0.5 ,0.5);
  makePerson(-5, 0, 0, 150, 32, 'shoulder_right_y', 'red',0.5 ,0.5);
  makePerson(3, 0, 0, 150, 32, 'thumb_right_y', 'red',0.5 ,0.5);
  makePerson(-1, 0, 0, 150, 32, 'wrist_right_y', 'red',0.5 ,0.5);

  makePerson(-3, 2, 0, 150, 32, 'elbow_right_x', 'red',0.5 ,0.5);
  makePerson(1, 2, 0, 150, 32, 'hand_right_x', 'red',0.5 ,0.5);
  makePerson(5, 2, 0, 150, 32, 'handtip_right_x', 'red',0.5 ,0.5);
  makePerson(-5, 2, 0, 150, 32, 'shoulder_right_x', 'red',0.5 ,0.5);
  makePerson(3, 2, 0, 150, 32, 'thumb_right_x', 'red',0.5 ,0.5);
  makePerson(-1, 2, 0, 150, 32, 'wrist_right_x', 'red',0.5 ,0.5);

  makePerson(-3, 4, 0, 150, 32, 'elbow_right_z', 'red',0.5 ,0.5);
  makePerson(1, 4, 0, 150, 32, 'hand_right_z', 'red',0.5 ,0.5);
  makePerson(5, 4, 0, 150, 32, 'handtip_right_z', 'red',0.5 ,0.5);
  makePerson(-5, 4, 0, 150, 32, 'shoulder_right_z', 'red',0.5 ,0.5);
  makePerson(3, 4, 0, 150, 32, 'thumb_right_z', 'red',0.5 ,0.5);
