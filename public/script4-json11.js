...
// controls.noZoom = true;
  ...
  const headGeometry = new THREE.CylinderGeometry(
      headRadius, headRadius, length, bodyRadialSegments);
    
    const headGeometry2 = new THREE.CylinderGeometry(
      headRadius, headRadius, length, bodyRadialSegments);
      // headGeometry.rotation.x = Math.PI / 2;
    ...
    const head2 = new THREE.Mesh(headGeometry2, bodyMaterial);
    // head2.name = name
    head.add(head2);
    head2.position.y = 1 + headRadius * 1.1;
