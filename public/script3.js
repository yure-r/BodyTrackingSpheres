...
let r = 7;
  ...
  makePerson(r*Math.cos(((0*Math.PI)/9)), r*Math.sin(((0*Math.PI)/9)), 0, 150, 32, 'elbow_right_y', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((1*Math.PI)/9)), r*Math.sin(((1*Math.PI)/9)), 0, 150, 32, 'hand_right_y', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((2*Math.PI)/9)), r*Math.sin(((2*Math.PI)/9)), 0, 150, 32, 'handtip_right_y', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((3*Math.PI)/9)), r*Math.sin(((3*Math.PI)/9)), 0, 150, 32, 'shoulder_right_y', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((4*Math.PI)/9)), r*Math.sin(((4*Math.PI)/9)), 0, 150, 32, 'thumb_right_y', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((5*Math.PI)/9)), r*Math.sin(((5*Math.PI)/9)), 0, 150, 32, 'wrist_right_y', 'red',0.5 ,0.5);

  makePerson(r*Math.cos(((6*Math.PI)/9)), r*Math.sin(((6*Math.PI)/9)), 0, 150, 32, 'elbow_right_x', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((7*Math.PI)/9)), r*Math.sin(((7*Math.PI)/9)), 0, 150, 32, 'hand_right_x', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((8*Math.PI)/9)), r*Math.sin(((8*Math.PI)/9)), 0, 150, 32, 'handtip_right_x', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((9*Math.PI)/9)), r*Math.sin(((9*Math.PI)/9)), 0, 150, 32, 'shoulder_right_x', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((10*Math.PI)/9)), r*Math.sin(((10*Math.PI)/9)), 0, 150, 32, 'thumb_right_x', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((11*Math.PI)/9)), r*Math.sin(((11*Math.PI)/9)), 0, 150, 32, 'wrist_right_x', 'red',0.5 ,0.5);

  makePerson(r*Math.cos(((12*Math.PI)/9)), r*Math.sin(((12*Math.PI)/9)), 0, 150, 32, 'elbow_right_z', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((13*Math.PI)/9)), r*Math.sin(((13*Math.PI)/9)), 0, 150, 32, 'hand_right_z', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((14*Math.PI)/9)), r*Math.sin(((14*Math.PI)/9)), 0, 150, 32, 'handtip_right_z', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((15*Math.PI)/9)), r*Math.sin(((15*Math.PI)/9)), 0, 150, 32, 'shoulder_right_z', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((16*Math.PI)/9)), r*Math.sin(((16*Math.PI)/9)), 0, 150, 32, 'thumb_right_z', 'red',0.5 ,0.5);
  makePerson(r*Math.cos(((17*Math.PI)/9)), r*Math.sin(((17*Math.PI)/9)), 0, 150, 32, 'wrist_right_z', 'red',0.5 ,0.5);


  //   let r = 9
  // makePerson(r*Math.cos(((0*Math.PI)/3)), r*Math.sin(((0*Math.PI)/3)), 150, 150, '-2, -4', 'purple', "https://cdn.glitch.com/3fdb2c88-1e2d-4819-b254-73ba1b867eaf%2FNewSkin_flipped4_2021-27.svg?v=1614833495658", "1");
  // makePerson(r*Math.cos(((1*Math.PI)/3)), r*Math.sin(((1*Math.PI)/3)), 150, 150, '-2, -4', 'purple', "https://cdn.glitch.com/3fdb2c88-1e2d-4819-b254-73ba1b867eaf%2FNewSkin_flipped4_2021-29.svg?v=1614833495659", "2");
  // makePerson(r*Math.cos(((2*Math.PI)/3)), r*Math.sin(((2*Math.PI)/3)), 150, 150, '-2, -4', 'purple', "https://cdn.glitch.com/3fdb2c88-1e2d-4819-b254-73ba1b867eaf%2FNewSkin_flipped4_2021-30.svg?v=1614833495707", "3");
  // makePerson(r*Math.cos(((3*Math.PI)/3)), r*Math.sin(((3*Math.PI)/3)), 150, 150, '-2, -4', 'purple', "https://cdn.glitch.com/3fdb2c88-1e2d-4819-b254-73ba1b867eaf%2FNewSkin_flipped4_2021-31.svg?v=1614833495740", "4");
  // makePerson(r*Math.cos(((4*Math.PI)/3)), r*Math.sin(((4*Math.PI)/3)), 150, 150, '-2, -4', 'purple', "https://cdn.glitch.com/3fdb2c88-1e2d-4819-b254-73ba1b867eaf%2FNewSkin_flipped4_2021-32.svg?v=1614833495788", "5");
  // makePerson(r*Math.cos(((5*Math.PI)/3)), r*Math.sin(((5*Math.PI)/3)), 150, 150, '-2, -4', 'purple', "https://cdn.glitch.com/3fdb2c88-1e2d-4819-b254-73ba1b867eaf%2FNewSkin_flipped4_2021-33.svg?v=1614833495838", "6");
