...
let r = 7;
  ...
  ELBOW_RIGHT.position.x = 0
  ELBOW_RIGHT.position.z = 2
  var ELBOW_LEFT = scene.getObjectByName('ELBOW_LEFT');
  ELBOW_LEFT.position.x = 0
  ELBOW_LEFT.position.z =  -2
  var WRIST_RIGHT = scene.getObjectByName('WRIST_RIGHT');
  WRIST_RIGHT.position.x = 0
  WRIST_RIGHT.position.z = 4
  var WRIST_LEFT = scene.getObjectByName('WRIST_LEFT');
  WRIST_LEFT.position.x = 0
  WRIST_LEFT.position.z =  -4
  var KNEE_RIGHT = scene.getObjectByName('KNEE_RIGHT');
  KNEE_RIGHT.position.x = 0
  KNEE_RIGHT.position.z = 6
  var KNEE_LEFT = scene.getObjectByName('KNEE_LEFT');
  KNEE_LEFT.position.x = 0
  KNEE_LEFT.position.z = -6
  var FOOT_RIGHT = scene.getObjectByName('FOOT_RIGHT');
  FOOT_RIGHT.position.x = 0
  FOOT_RIGHT.position.z = 8
  var FOOT_LEFT = scene.getObjectByName('FOOT_LEFT');
  FOOT_LEFT.position.x = 0
  FOOT_LEFT.position.z = -8
  console.log(HEAD)
  HEAD.parent.children[1].position.x = 0
  HEAD.parent.children[1].position.z = 0
  ELBOW_RIGHT.parent.children[1].position.x = 0
  ELBOW_RIGHT.parent.children[1].position.z = 2
  // var ELBOW_LEFT = scene.getObjectByName('ELBOW_LEFT');
  ELBOW_LEFT.parent.children[1].position.x = 0
  ELBOW_LEFT.parent.children[1].position.z =  -2
  // var WRIST_RIGHT = scene.getObjectByName('WRIST_RIGHT');
  WRIST_RIGHT.parent.children[1].position.x = 0
  WRIST_RIGHT.parent.children[1].position.z = 4
  // var WRIST_LEFT = scene.getObjectByName('WRIST_LEFT');
  WRIST_LEFT.parent.children[1].position.x = 0
  WRIST_LEFT.parent.children[1].position.z =  -4

  KNEE_RIGHT.parent.children[1].position.x = 0
  KNEE_RIGHT.parent.children[1].position.z = 6
  // var KNEE_LEFT = scene.getObjectByName('KNEE_LEFT');
  KNEE_LEFT.parent.children[1].position.x = 0
  KNEE_LEFT.parent.children[1].position.z = -6
  FOOT_RIGHT.parent.children[1].position.x = 0
  FOOT_RIGHT.parent.children[1].position.z = 8
  // var FOOT_LEFT = scene.getObjectByName('FOOT_LEFT');
  FOOT_LEFT.parent.children[1].position.x = 0
  FOOT_LEFT.parent.children[1].position.z = -8
